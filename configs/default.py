...
_C.DATA.use_context = False
# the pretrained language model to use. Please pre-download. default is RoBERTa.
if flag=='ro':
    _C.DATA.plm = '/mnt/MisNet-main/roberta-base'
else:
    _C.DATA.plm = '../roberta-base'
# _C.DATA.plm = '/mnt/MisNet-main/flava-full'
