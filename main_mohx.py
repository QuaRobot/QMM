...
from train_val import train, val, load_plm, set_random_seeds,exp
...
def main(args,k1,k2):
    ...
    for i in range(10):
        ...
        model = QLModel(args=args, plm=plm,k1=k1,k2=k2)
...
if __name__ == '__main__':
    ...
    args = parse_option()
    for i in settings:
        print("___________________________"+str(i)+"__________________________")
        main(args, i[0],i[1])
